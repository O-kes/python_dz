...
for x in range(a,b +1):
    ...
    if x % 3 != 0 and x % 5 != 0:
        print(x)
# первый код работает правильно при проверке числа 15, которое кратно
#всем 3 условиям ( 3, 5, 3 и 5) выводятся все три надписи.

# Почему не получается решить эту задачу с помощью elif и else?
# не корректно выводятся слова при проверке числа 15, в чем проблема?
# a = 1
# b = 15
#
# for x in range (a,b +1):
